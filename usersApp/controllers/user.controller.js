...
exports.findOne = async(req, res) => {
  console.log('Find user with specific user name');
  ...
  try {
    ...
    res.status(404).json({status: false, data: 'User doesnt exist'})}
   } catch (err) {
    console.log('Problem in finding the specific user', err);
    res.status(400).json({status: false, data: err});
    }
  }
...
exports.create = async(req, res) => {
  ...
  try {
    ...
    console.log('Problem in creating the user', err);
    res.status(400).json({status: false, data: err});
  };
}
...
exports.update = async(req, res) => {
  ...
  try {
    ...
    console.log('Problem in updatin user', err);
...
exports.deleteByEmail = async (req, res) => {
  ...
  try {
    ...
    console.log('Problem in deleting email')
    res.status(400).json({status: false, data: err})
  }
}
